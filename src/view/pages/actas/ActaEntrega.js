...
const ActaDefensa = () => {
  ...
  async function solicitarCarta(e) {
    ...
    try {
      const datos = {persona1: persona1, persona2: persona2, lugar: lugar}
      const { data, error } = await supabase
        .from('Acta')
        .insert({
          ...
          datos: datos,
          semestre: semestre,
          machote: "Acta de entrega de informe final"
        })
        .select();
  ...
  return (
    <div>
      <Header title={"Solicitar acta de entrega de informe"}></Header>
      ...
      <form className={styles.form} onSubmit={solicitarCarta}>
        ...
        <div className={styles.formGroup}>
          <label>Lugar donde se realizó la defensa:</label>
          <input
            type="text"
            value={lugar}
        ...
        <div className={styles.formGroup}>
          <label>Coordinador(a) Programa Vinculación Empresarial:</label>
          <input
            type="text"
            value={persona1}
        ...
        <div className={styles.formGroup}>
          <label>Director(a) Escuela de Ingeniería en Producción Industrial:</label>
          <input
            type="text"
            value={persona2}
